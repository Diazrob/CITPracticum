...
namespace CITPracticum.Data.Migrations
{
    ...
    [Migration("20240331160505_Updating-Employer-Model")]
    partial class UpdatingEmployerModel
    {
            ...
            modelBuilder.Entity("CITPracticum.Models.FormA", b =>
                {
                    ...
                    b.Property<string>("SVFirstName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SVLastName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CITPracticum.Models.AppUser", b =>
                {
                    ...
                    b.HasOne("CITPracticum.Models.Instructor", "Instructor")
                        .WithMany()
